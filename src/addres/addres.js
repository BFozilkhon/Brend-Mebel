            ...
            <div className='addres-container'>
                   <div className='addres-box'>
                       <div className='addres-card'>
                           ...
                           <a target='_blank' href='https://www.google.com/maps/place/%D0%9C%D0%B0%D0%BB%D0%B8%D0%BA%D0%B0+%D0%91%D0%BE%D0%BD%D1%83/@41.3483462,69.1728602,17z/data=!3m1!4b1!4m5!3m4!1s0x38ae8e946b73658b:0x12d6d8af3152166a!8m2!3d41.3483462!4d69.1728602'>
                           <button className='addres-btn'>Google Karta</button>
                           </a>
                       </div>
                       <img className='addres-img'  src={addresImg} />
                   </div>
                  ...
                  <div className='addres-yangiilklar'>
                   ...
                   <div className='foiz-va-chegirma'>
                         <img className='foiz-chegirma' src={chegirma} />
                         <img className='foiz-puls' src={plus} />
                         <img className='foiz-dostavka' src={dostavka} />
                   </div>
